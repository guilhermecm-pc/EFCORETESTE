...
namespace EFCORETESTE.Migrations
{
    ...
    [Migration("20241119104538_Novo1")]
    partial class Novo1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCORETESTE.Models.Hospede", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCORETESTE.Models.Quarto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCORETESTE.Models.Reserva", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCORETESTE.Models.Reserva", b =>
                {
                    b.HasOne("EFCORETESTE.Models.Hospede", "hospede")
                        .WithMany()
                        .HasForeignKey("hospedeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EFCORETESTE.Models.Quarto", "quarto")
                        .WithMany()
